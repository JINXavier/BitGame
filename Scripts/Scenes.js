class Scene1 extends Phaser.Scene {
    ...
    create() {
        let button = this.add.image(300, 180, 'play')
...
class Scene3 extends Phaser.Scene {
    ...
    create() {
        ...
        let boy = this.add.image(160, 200, 'boy').setScale(0.4)
        let girl = this.add.image(460, 200, 'girl').setScale(0.4)
...
class GameScene2 extends Phaser.Scene {
    ...
    preload() {
        ...
        this.load.tilemapTiledJSON('map2', 'Scripts/JSON/GameTileDemo2.json')
